...
* [x] The searchbar for better game access.
...
Some challenges I had with the app were getting the syntax down for javaScript and the reduce function at first.

## License

    Copyright [2026] [Vivian Vu]
